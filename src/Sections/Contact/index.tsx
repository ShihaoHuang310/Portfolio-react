    ...
    <section id="contact" ref={container}>
      <div className="container">
          ...
          <div className="box">
            <div className="cluster">
              ...
              <p className="description">
                amazing together! Description: Feel free to reach out for projects, collaborations,
                or web development inquiries via the form or email!
              </p>
            </div>
        ...
        <form className="contact__form">
          ...
          <button type="button" className="btn btn__primary submit__btn">
            Send Now
          </button>
        </form>
      </div>
